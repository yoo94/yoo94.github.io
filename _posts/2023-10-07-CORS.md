...
<div style="display: flex; justify-content: center;">
  <img src="/blog/postImg/Pasted image 20240202165833.png" alt="Pasted image 20240202165833.png" style="max-width:100%;; height:70%;">
</div>
...
<div style="display: flex; justify-content: center;">
  <img src="/blog/postImg/Pasted image 20240202170012.png" alt="Pasted image 20240202170012.png" style="max-width:100%;; height:70%;">
</div>

####### 요청하는 클라이언트와 요청받는 서버가 **같은 출처에 있으면 동일 출처**, **서로 다른 서버에 있으면 다른 출처 요청**
<div style="display: flex; justify-content: center;">
  <img src="/blog/postImg/Pasted image 20240202170045.png" alt="Pasted image 20240202170045.png" style="max-width:100%;; height:70%;">
</div>
...
- Contet-Type 헤더는 application/x-www-form-urlencoded, multipart/form-data and text/plain만 가능
  ...
  <div style="display: flex; justify-content: center;">
  <img src="https://developer.mozilla.org/ko/docs/Web/API/ReadableStream" alt="https://developer.mozilla.org/ko/docs/Web/API/ReadableStream" style="max-width:100%;; height:70%;">
</div>
...
```
<div style="display: flex; justify-content: center;">
  <img src="/blog/postImg/Pasted image 20240202170146.png" alt="Pasted image 20240202170146.png" style="max-width:100%;; height:70%;">
</div>
...
```
<div style="display: flex; justify-content: center;">
  <img src="/blog/postImg/Pasted image 20240202170258.png" alt="Pasted image 20240202170258.png" style="max-width:100%;; height:70%;">
</div>
