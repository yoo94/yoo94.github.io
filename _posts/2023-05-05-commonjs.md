...
- 프론트엔드
- 백엔드
keywords: JavaScript 모듈, CommonJS, AMD, UMD, ESM, requirejs, import, export, 모듈화, 비동기 로딩, 동기 로딩, 모듈 패턴, 서버 사이드 자바스크립트, 클라이언트 사이드 자바스크립트, 모듈 시스템 비교, ECMAScript 모듈
...
##### AMD 구문 ( 사용법 )
![https://defineall.tistory.com/916#AMD%20%EA%B5%AC%EB%AC%B8%20(%20%EC%82%AC%EC%9A%A9%EB%B2%95%20)-1](https://defineall.tistory.com/916#AMD%20%EA%B5%AC%EB%AC%B8%20(%20%EC%82%AC%EC%9A%A9%EB%B2%95%20)-1)
...
##### AMD를 사용하는 라이브러리
  ![https://defineall.tistory.com/916#AMD%EB%A5%BC%20%EC%82%AC%EC%9A%A9%ED%95%98%EB%8A%94%20%EB%9D%BC%EC%9D%B4%EB%B8%8C%EB%9F%AC%EB%A6%AC-1](https://defineall.tistory.com/916#AMD%EB%A5%BC%20%EC%82%AC%EC%9A%A9%ED%95%98%EB%8A%94%20%EB%9D%BC%EC%9D%B4%EB%B8%8C%EB%9F%AC%EB%A6%AC-1)

- RequireJS
- PINF

#### UMD (Univarsal Module Definition)
  ![sss](https://defineall.tistory.com/916#%F0%9F%91%89%C2%A0UMD%20(Univarsal%20Module%20Definition)-1)

> AMD와 CommonJS가 서로 호환되지 않는 문제를 해결하기 위한 API

##### UMD 구문 ( 사용법 )
  ![png](https://defineall.tistory.com/916#UMD%20%EA%B5%AC%EB%AC%B8%20(%20%EC%82%AC%EC%9A%A9%EB%B2%95%20)-1)
